...
arguments
    ...
    options.SkipPowerPlot = 1
    options.BandRectangles = 1
end
...
[pulse_voltage,pulse_Er,bands_power,figure_handle] = ...
    ...
    "SkipPowerPlot",options.SkipPowerPlot,...
    "BandRectangles",options.BandRectangles,...
    "SavePulseMat",options.SavePulseMat,...
